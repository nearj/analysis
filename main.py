...
def mpentropy_handler(motion_path, visual_path, output_path):
    ...
    #                                             save                                            #
    ###############################################################################################
    df = pd.DataFrame(np.array([mp_entropy, incidence]).T, times)
    df.index.name = ['Time']
...
def main(args):
    ...
    mpentropy_handler(motion_path, visual_path, output_path)
