...
##########################################
class ANALYSER: #obselete
    def __init__(self, name: str, time: int, sample_rate: int, sample_ent):
        self.name = name
        self.time = time
        self.sample_rate = sample_rate
        self._sample_ent = sample_ent

    def calc_spearman(self):
        self.spearmanr = spearmanr(self._sample_ssq, self._sample_ssq)

    def calc_kendalltau(self):
        self.kendalltau = kendalltau(self._sample_ssq, self._sample_ssq)

    def get_spearman(self):
        return self.spearmanr

    def get_kendalltau(self):
        return self.kendalltau
